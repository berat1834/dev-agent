...
### 📤 Güncellemeyi GitHub'a Gönderme

Dosyayı kaydettikten sonra terminalde sırasıyla şu 3 komutu çalıştır:

```powershell
git add README.md
git commit -m "docs: update README with correct repo url and web ui commands"
git push
